...
"""
    adjtdvp1vec!(
        ...
        Δt::Number, tf::Number, meas_stride::Number; kwargs...
    )
...
function adjtdvp1vec!(
    ...
    return adjtdvp1vec!(
        solver, operator, [initialstate], PH, Δt, tf, meas_stride; kwargs...
    )
end
...
function adjtdvp1vec!(
    ...
    return adjtdvp1vec!(
        solver, operator, initialstates, ProjMPO(H), Δt, tf, meas_stride; kwargs...
    )
end
...
function adaptiveadjtdvp1vec!(
    ...
    return adaptiveadjtdvp1vec!(
        solver, operator, initialstate, PLs, Δt, tf, meas_stride; kwargs...
    )
end
...
function adaptiveadjtdvp1vec!(
    ...
    return adaptiveadjtdvp1vec!(
        solver, operator, initialstate, ProjMPO(L), Δt, tf, meas_stride; kwargs...
    )
end
